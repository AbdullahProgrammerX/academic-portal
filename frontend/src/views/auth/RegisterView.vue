        ...
        <div class="rounded-md shadow-sm space-y-4">
          ...
          <div>
            ...
            <Field
              ...
              :class="errors.full_name ? 'border-red-300 text-red-900 placeholder-red-300 focus:ring-red-500 focus:border-red-500' : 'border-gray-300 placeholder-gray-400 text-gray-900'"
          ...
          <div>
            ...
            <Field
              ...
              autocomplete="new-password"
              class="mt-1 appearance-none relative block w-full px-3 py-2 border rounded-md focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm"
              :class="errors.password_confirm ? 'border-red-300 text-red-900 placeholder-red-300 focus:ring-red-500 focus:border-red-500' : 'border-gray-300 placeholder-gray-400 text-gray-900'"
              placeholder="••••••••"
            />
            <ErrorMessage name="password_confirm" class="mt-1 text-sm text-red-600" />
          </div>
        </div>
...
// Handle ORCID registration
async function handleORCIDRegister() {
  try {
